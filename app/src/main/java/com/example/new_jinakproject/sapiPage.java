...
public class sapiPage extends AppCompatActivity {
    ImageButton back;
    ListView list;
    String[] mJenis = {"Sapi Putih", "Sapi Hitam Putih", "Sapi Coklat", "Sapi Putih mulus", "Sapi Putih Hitam", "Choco Cow"};
    ...
    Integer[] mImgs = {R.drawable.sapi1, R.drawable.sapi2, R.drawable.sapi3, R.drawable.sapi1, R.drawable.sapi2, R.drawable.sapi3};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sapi_page);
